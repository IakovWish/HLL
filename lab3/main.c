...
int main()
{
    ...
    do
    {
        cout << "Введите цифру соответствующую необходимому пункту меню:" << endl << " 1 - Рандомная ссылка" << endl << "2 - Ручной выбор" << endl;
        cin >> menu;
        switch (menu) {
        case 2:
        {
            cout << "Введите цифру соответствующую необходимому пункту меню:" << endl
                << " 0 - Основная страница google;" << endl
                << "Необходимо выбрать сервис, страницу, которого хотим открыть:" << endl
        ...
        case 0:
        {
            cout << "Сайт сервиса был открыт" << endl;
            google();
            break;
        }
        case 1:
